...
// https://res.wx.qq.com/voice/getvoice?mediaid=Mzg5MzAyODQxOF8yMjQ3NDgzODk3
//https://res.wx.qq.com/voice/getvoice/mediaid=Mzg5MzAyODQxOF8yMjQ3NDgzODk3
    static final String neteaseReferer = "https://res.wx.qq.com/voice/getvoice";
    static final String neteeaseHost = "res.wx.qq.com/voice/getvoice";

    public static void main(String[] args) throws IOException {
        String url =  neteaseReferer+"?mediaid=Mzg5MzAyODQxOF8yMjQ3NDgzODk3";  //mv 视频地址

        System.out.println(user_Agent[0]);
        //请求header 设置
        ...
        config.put("Content-Type", "audio/mp3");

        Document res = Jsoup.connect(url).headers(config).get();

        //解析框架源代码中的 mv 播放url  audio/mp3
        Element element = res.select("meta[property=og:audio]").first();
    ...
    public static void downloadFile(String downloadURL, String savePath) throws MalformedURLException, MalformedURLException {
        ...
        try {
            ...
            File file = new File("target/moxi.mp3");
